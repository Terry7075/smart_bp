...
class AdminDashboardPage extends ConsumerWidget {
  ...
  void _goBack(BuildContext context) {
    ...
    context.go('/volunteer-dashboard?tab=3');
  }
                  ...
                  children: [
                    Wrap(
                      ...
                      children: [
                        _MetricCard(
                          label: '待媒合接送',
                          value: item.pendingRideCount,
                        ),
                        _MetricCard(label: '今日行程', value: item.todayRideCount),
                        _MetricCard(
                          label: '今日已媒合',
                          value: item.todayMatchedCount,
                        ),
                        _MetricCard(
                          label: '進行中接送',
                    ...
                    FilledButton(
                      onPressed: () => context.push('/transport/admin/drivers'),
                      child: const Text('司機審核'),
                    ),
                    const SizedBox(height: 12),
                    FilledButton(
                      onPressed: () =>
                          context.push('/transport/admin/standing'),
                    ...
                    const SizedBox(height: 12),
                    FilledButton(
                      onPressed: () => context.push('/transport/admin/live'),

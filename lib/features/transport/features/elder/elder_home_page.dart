          ...
          data: (items) {
            ...
            return SingleChildScrollView(
              ...
              child: Column(
                ...
                children: [
                  Text('目前接送狀態', style: Theme.of(context).textTheme.titleLarge),
                      ...
                      child: current == null
                          ...
                          : Column(
                              ...
                              children: [
                                ...
                                OutlinedButton(
                                  onPressed: () =>
                                      context.push('/transport/elder/ride/${current.id}'),
                  ...
                  const SizedBox(height: 12),
                  OutlinedButton.icon(
                    onPressed: () => context.push('/transport/elder/standing'),
                  ...
                  if (application == null)
                    OutlinedButton(
                      onPressed: () => context.push('/transport/driver/apply'),
                      child: const Text('申請成為司機'),
                    )
                  else if (application.isPending)
                    OutlinedButton(
                      onPressed: () => context.push('/transport/driver/pending'),
